          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#f5f8ff] border border-[#3f63ad]/15 rounded-xl p-7 hover:border-[#3f63ad]/35 hover:shadow-lg hover:shadow-[#3f63ad]/8 transition-all duration-300 group">
              <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-[#98b3d9] text-xs font-mono">arXiv · 2026</span>
                  </div>
                  <h3 className="text-base font-bold text-[#1a2744] group-hover:text-[#3f63ad] transition-colors leading-snug">
                    Enhancing Human-Likeness in Reinforcement Learning Agents via Hierarchical Macro
                    Action Quantization
                  </h3>
                </div>
              </div>
              ...
              <p className="text-[#5a6a8a] text-sm leading-relaxed mb-5">
                Introduced a human-like RL framework that encodes human demonstrations into macro actions
                via a two-level hierarchical macro action quantization approach (HiMAQ), applied to
                dexterous control of a humanoid robot hand. On the D4RL benchmarks it outperforms the
                non-hierarchical MAQ baseline on human-likeness while matching or exceeding success rates,
                generalizing across IQL, SAC, and RLPD.
              </p>
